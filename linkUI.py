...
from PyQt5.QtCore import QDate, QTimer, QTime, QDateTime, Qt #增加的包
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.logo.setGeometry(QRect(20, 10, 250, 51))
        self.logo.setText("")
        self.logo.setPixmap(QPixmap(linkpath + r'\timg.png'))
        self.logo.setObjectName("logo")
        self.text = QLabel(self.groupBox_4)
        self.text.setGeometry(QRect(150, 0, 122, 49))

        self.timeLable = QLabel(self.groupBox_4)
        self.timeLable.setGeometry(QRect(140, 35, 300, 30))
        font = QFont()
        font.setFamily("华文中宋")
        font.setPointSize(10)
